...
export default function Products() {
  ...
  const { items, loading, error, pagination, setPage, create, update, remove } = useApiResource('/products')
  ...
  return (
    <>
      ...
      <DataTable
        ...
        actions={(row) => (
          <>
            <Button variant="secondary" size="sm" onClick={() => navigate(`/products/${row.id}`)}>عرض</Button>
