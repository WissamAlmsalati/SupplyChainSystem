...
class ProductSearchTest extends TestCase
{
    ...
    public function test_favorites_filter_and_card_fields(): void
    {
        ...
        $this->assertSame(['id', 'name', 'brand', 'image_url', 'image_type', 'image_is_placeholder', 'min_price', 'max_price', 'in_stock', 'category_id', 'default_variant_id', 'is_favorite'], array_keys($card));
