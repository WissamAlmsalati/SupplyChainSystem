 ...
 *
 * @OA\Patch(path="/delegates/{id}/location", tags={"Delegates"}, summary="Set a delegate's location (delegate_profiles)", security={{"bearerAuth":{}}},
 *
 *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
 *
 ...
 * // POST /payments is documented on PaymentController, with the rule that a
 * // payment may never exceed what the order still owes.
 ...
 * // POST /logout is documented on AuthController.
 *
 ...
 *
 *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")), @OA\Response(response=200, description="Wallet"))
 * // GET /wallet-topups is documented on WalletTopupController, with its status counts.
 *
