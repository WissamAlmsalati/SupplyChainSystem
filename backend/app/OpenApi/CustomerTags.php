 ...
 *
 * @OA\Tag(name="Customer Auth", description="الدخول، التسجيل برقم الهاتف والتحقق (OTP)، استعادة كلمة المرور، `me` والخروج. كلها تحت `/customer/`.")
 ...
 * @OA\Tag(name="Customer Notifications", description="إشعارات الزبون: القائمة، عدد غير المقروء، التحديد كمقروء والحذف.")
 */
class CustomerTags
{
    //
